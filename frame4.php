...
<html>
  <head>
    <style>
     ...
     <script>
      //alert("http://localhost/old/viewpay.php");
...
?>
      ...
      <div class="contain">
        ...
        cast<p>:<?php echo $cast;?></p>
        religion<p>:<?php echo $religion;?></p>
        <span><p>Address:<br><?php echo $address;?></p></span>
      
      
        
        <br><br>
        <a href="http://localhost/old/Mhome.php">
    <img src="home.jpg" width="55" height="55"  id="homes" class="homes">
   </a>
