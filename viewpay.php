...
?>
      ...
      <br><br>
<form name="myform" method="post" action="frame4.php?id=<?php echo$row["id"]; ?>" onsubmit="return validateform()">  
...
<input type="radio" id="b2" name="payments" class="radio" value="paytm"><b>payTM</b><br>
